...
# ---------------------------------------------------------------------------
# ARCHITECTURAL DRAFTER CLASS
# ---------------------------------------------------------------------------
# The ArchitecturalDrafter wraps all tricky AutoCAD COM geometry math so the AI
# never has to do offset/door-arc/label math itself (it kept crashing). The AI
# only calls d.draw_wall(), d.draw_room(), d.draw_door() etc.
# It is regenerated into cad.py / rhino.py / sketchup.rb by scaffold_environments().
# ---------------------------------------------------------------------------
